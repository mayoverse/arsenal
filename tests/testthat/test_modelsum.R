...
test_that("A basic modelsum call--no labels, no missings", {
  expect_true(
    identical(capture.output(summary(modelsum(Age ~ Sex + time, data = mdat), text = TRUE)),
      c("----------------------------------------------------------------------------------",
...
test_that("A basic modelsum tableby call--labels, no missings", {
  expect_true(
    identical(capture.output(summary(modelsum(Age ~ Sex + trt, data = mdat), text = TRUE)),
      c("----------------------------------------------------------------------------------",
        "                    estimate        std.error       p.value         adj.r.squared ",
        "------------------ --------------- --------------- --------------- ---------------",
        "(Intercept)        39.8            0.779           <0.001          -0.011         ",
...
test_that("A basic modelsum call--adding adjustment", {
  expect_true(
    identical(capture.output(summary(modelsum(Age ~ Sex + time, adjust = ~ trt, data = mdat), text = TRUE)),
      c("----------------------------------------------------------------------------------",
        "                    estimate        std.error       p.value         adj.r.squared ",
        "------------------ --------------- --------------- --------------- ---------------",
...
test_that("A basic modelsum call--suppressing intercept and/or adjustment vars", {
  expect_true(
    identical(capture.output(summary(modelsum(Age ~ Sex + time, adjust = ~ trt, data = mdat), text = TRUE, show.intercept = FALSE)),
      c("----------------------------------------------------------------------------------",
        "                    estimate        std.error       p.value         adj.r.squared ",
        "------------------ --------------- --------------- --------------- ---------------",
  ...
  expect_true(
    identical(capture.output(summary(modelsum(Age ~ Sex + time, adjust = ~ trt, data = mdat), text = TRUE, show.adjust = FALSE)),
      c("----------------------------------------------------------------------------------",
        "                    estimate        std.error       p.value         adj.r.squared ",
        "------------------ --------------- --------------- --------------- ---------------",
        "(Intercept)        40.6            1.02            <0.001          -0.005         ",
  ...
  expect_true(
    identical(capture.output(summary(modelsum(Age ~ Sex + time, adjust = ~ trt, data = mdat), text = TRUE, show.intercept = FALSE, show.adjust = FALSE)),
      c("----------------------------------------------------------------------------------",
        "                    estimate        std.error       p.value         adj.r.squared ",
        "------------------ --------------- --------------- --------------- ---------------",
        "Sex Male           -0.221          1.11            0.843           -0.005         ",
