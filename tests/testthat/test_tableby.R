...
test_that("A basic two-sided tableby call--no labels, no missings", {
  expect_true(
    identical(capture.output(summary(tableby(Group ~ Sex + time + dt, data = mdat), text = TRUE)),
      c("--------------------------------------------------------------------------------------------",
...
test_that("A basic two-sided tableby call--labels, no missings", {
  expect_true(
    identical(capture.output(summary(tableby(Group ~ Age + trt, data = mdat), text = TRUE)),
      c("--------------------------------------------------------------------------------------------",
        "                   High (N=30)    Low (N=30)     Med (N=30)     Total (N=90)   p value      ",
        "----------------- -------------- -------------- -------------- -------------- --------------",
        "Age in Years                                                                           0.906",
...
test_that("A basic two-sided tableby call--no labels, some missings", {
  expect_true(
    identical(capture.output(summary(tableby(Group ~ ethan, data = mdat), text = TRUE)),
      c("--------------------------------------------------------------------------------------------",
        "                   High (N=30)    Low (N=30)     Med (N=30)     Total (N=90)   p value      ",
        "----------------- -------------- -------------- -------------- -------------- --------------",
        "ethan                                                                                  0.178",
...
test_that("A basic one-sided tableby call--no labels, no missings", {
  expect_true(
    identical(capture.output(summary(tableby(~ Sex + time + dt, data = mdat), text = TRUE)),
      c("------------------------------------",
        "                     Overall (N=90) ",
        "------------------- ----------------",
        "Sex                "                 ,
...
test_that("A basic one-sided tableby call--labels, no missings", {
  expect_true(
    identical(capture.output(summary(tableby(~ Age + trt, data = mdat), text = TRUE)),
      c("------------------------------------",
        "                     Overall (N=90) ",
        "------------------- ----------------",
        "Age in Years       "                 ,
...
test_that("A basic one-sided tableby call--no labels, some missings (Sarah Jenkins's Error)", {
  expect_true(
    identical(capture.output(summary(tableby(~ ethan, data = mdat), text = TRUE)),
      c("------------------------------------",
        "                     Overall (N=90) ",
        "------------------- ----------------",
        "ethan              "                 ,
...
test_that("A basic two-sided tableby call--no p-value, no total", {
  expect_true(
    identical(capture.output(summary(tableby(Group ~ Age + Sex, data = mdat, test = FALSE, total = FALSE), text = TRUE)),
      c("----------------------------------------------------------",
...
test_that("A basic two-sided tableby call--p-value, no total", {
  expect_true(
    identical(capture.output(summary(tableby(Group ~ Age + Sex, data = mdat, total = FALSE), text = TRUE)),
      c("------------------------------------------------------------------------",
...
test_that("A basic two-sided tableby LaTeX output", {
  expect_true(
    identical(capture.output(summary(tableby(Group ~ Age + Sex + ethan + dt, data = mdat, total = FALSE))),
      c("------------------------------------------------------------------------",
        "                  High (N=30)   Low (N=30)    Med (N=30)    p value     ",
        "---------------- ------------- ------------- ------------- -------------",
        "**Age in Years**                                                   0.906",
...
test_that("The by-variable droplevels is working correctly", {
  expect_true(
    identical(capture.output(summary(tableby(Group.fac ~ Sex + time + dt,
                                             data = mdat[mdat$Group.fac %in% c("High", "Low"), ]), text = TRUE)),
      c("-----------------------------------------------------------------------------",
...
test_that("Using cat.simplify", {
  expect_true(
    identical(capture.output(summary(tableby(Group ~ Sex + trt, data = mdat, cat.simplify = TRUE), text = TRUE)),
      c("--------------------------------------------------------------------------------------------",
        "                   High (N=30)    Low (N=30)     Med (N=30)     Total (N=90)   p value      ",
        "----------------- -------------- -------------- -------------- -------------- --------------",
...
test_that("Reordering variables", {
  expect_true(
    identical(capture.output(summary(tableby(Group ~ Sex + dt + Age, data = mdat)[c(3,1,2)], text = TRUE)),
      c("--------------------------------------------------------------------------------------------",
        "                   High (N=30)    Low (N=30)     Med (N=30)     Total (N=90)   p value      ",
        "----------------- -------------- -------------- -------------- -------------- --------------",
        "Age in Years                                                                           0.906",
...
test_that("Merging tableby objects", {
  ...
  expect_true(
    identical(capture.output(summary(merge(tableby(Group ~ Sex, data = mdat), tableby(Group ~ Age, data = mdat)),
                             text = TRUE)),
      c("--------------------------------------------------------------------------------------------",
        "                   High (N=30)    Low (N=30)     Med (N=30)     Total (N=90)   p value      ",
        "----------------- -------------- -------------- -------------- -------------- --------------",
...
test_that("Changing tests", {
  expect_true(
    identical(capture.output(summary(tableby(Group ~ fe(Sex) + kwt(Age), data = mdat), text = TRUE)),
      c("--------------------------------------------------------------------------------------------",
        "                   High (N=30)    Low (N=30)     Med (N=30)     Total (N=90)   p value      ",
        "----------------- -------------- -------------- -------------- -------------- --------------",
        "Sex                                                                                    0.806",
  ...
  expect_true(
    identical(capture.output(summary(tableby(Group ~ Sex + Age, data = mdat, numeric.test = "kwt",
                                             cat.test = "fe"), text = TRUE)),
      c("--------------------------------------------------------------------------------------------",
        "                   High (N=30)    Low (N=30)     Med (N=30)     Total (N=90)   p value      ",
        "----------------- -------------- -------------- -------------- -------------- --------------",
        "Sex                                                                                    0.806",
