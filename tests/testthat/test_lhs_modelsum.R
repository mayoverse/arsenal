...
test_that("Multiple adjustments work (#240)", {
  ...
  expect_identical(
    ...
    c("|sex    |adjustment       |Age in Years                |estimate |std.error |p.value |adj.r.squared |Nmiss |",
      ...
      "|       |Unadjusted       |(Intercept)                 |61.556   |0.696     |< 0.001 |0.003         |162   |",
      "|       |                 |**AST**                     |-0.028   |0.016     |0.074   |              |      |",
      "|       |Adjusted for Arm |(Intercept)                 |61.524   |0.947     |< 0.001 |0.001         |162   |",
      "|       |                 |**AST**                     |-0.028   |0.016     |0.075   |              |      |",
      "|       |                 |**Treatment Arm F: FOLFOX** |0.322    |0.977     |0.741   |              |      |",
      "|       |                 |**Treatment Arm G: IROX**   |-0.445   |1.115     |0.690   |              |      |",
      "|       |HGB + PS         |(Intercept)                 |57.707   |3.133     |< 0.001 |0.006         |162   |",
      ...
      "|       |Unadjusted       |(Intercept)                 |61.001   |0.883     |< 0.001 |0.004         |104   |",
      "|       |                 |**AST**                     |-0.033   |0.020     |0.096   |              |      |",
      "|       |Adjusted for Arm |(Intercept)                 |60.687   |1.266     |< 0.001 |0.006         |104   |",
      "|       |                 |**AST**                     |-0.032   |0.020     |0.102   |              |      |",
      "|       |                 |**Treatment Arm F: FOLFOX** |1.253    |1.297     |0.334   |              |      |",
      "|       |                 |**Treatment Arm G: IROX**   |-1.006   |1.441     |0.486   |              |      |",
      "|       |HGB + PS         |(Intercept)                 |47.825   |4.730     |< 0.001 |0.017         |104   |",
      ...
      "|       |Unadjusted       |(Intercept)                 |27.885   |0.306     |< 0.001 |0.006         |162   |",
      "|       |                 |**AST**                     |-0.016   |0.007     |0.023   |              |      |",
      "|       |Adjusted for Arm |(Intercept)                 |28.040   |0.412     |< 0.001 |0.004         |162   |",
      "|       |                 |**AST**                     |-0.016   |0.007     |0.023   |              |      |",
      "|       |                 |**Treatment Arm F: FOLFOX** |-0.354   |0.427     |0.408   |              |      |",
      "|       |                 |**Treatment Arm G: IROX**   |0.015    |0.486     |0.976   |              |      |",
      "|       |HGB + PS         |(Intercept)                 |24.297   |1.350     |< 0.001 |0.032         |162   |",
      ...
      "|       |Unadjusted       |(Intercept)                 |26.500   |0.456     |< 0.001 |0.001         |104   |",
      "|       |                 |**AST**                     |0.012    |0.010     |0.247   |              |      |",
      "|       |Adjusted for Arm |(Intercept)                 |26.062   |0.649     |< 0.001 |0.008         |104   |",
      "|       |                 |**AST**                     |0.012    |0.010     |0.225   |              |      |",
      "|       |                 |**Treatment Arm F: FOLFOX** |1.102    |0.669     |0.100   |              |      |",
      "|       |                 |**Treatment Arm G: IROX**   |-0.276   |0.741     |0.710   |              |      |",
      "|       |HGB + PS         |(Intercept)                 |27.324   |2.462     |< 0.001 |-0.003        |104   |",
