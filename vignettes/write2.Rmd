...
```{r echo = FALSE}
trash <- file.remove(paste0(tmpdir, c("/test.tableby.html", "/test.modelsum.pdf", "/test.freqlist.doc", "/test.kable.html", "/test.xtable.pdf",
                                      "/test.xtable.html", "/test.pander.doc", "/test.kable.quiet.html", "/test.kable.keep.md.html",
                                      "/test.kable.keep.md.html.md", "/test.kable.theme.html", "/test.kable.rtf")))
stopifnot(all(trash))
```
